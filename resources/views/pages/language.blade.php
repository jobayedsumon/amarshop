...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{ cdn('material') }}/img/apple-icon.png">
  <link rel="icon" type="image/png" href="{{ cdn('material') }}/img/favicon.png">
  ...
  <link href="{{ cdn('material') }}/css/material-dashboard-rtl.css?v=1.1" rel="stylesheet" />
...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="{{ cdn('material') }}/img/sidebar-1.jpg">
      <!--
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="#pablo">
                    <img class="img" src="{{ cdn('material') }}/img/faces/marc.jpg" />
                  </a>
                </div>
                <div class="card-body">
