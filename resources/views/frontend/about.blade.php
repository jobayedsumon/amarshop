...
@section('content')
                ...
                <div class="col-12">
                   <figure>
                        <div class="about_thumb">
                            <img src="{{ cdn('frontend') }}/img/about/about1.jpg" alt="">
                        </div>
                        <figcaption class="about_content">
                            ...
                            <div class="about_signature">
                                <img src="{{ cdn('frontend') }}/img/about/about-us-signature.png" alt="">
                            </div>
                        </figcaption>
                    </figure>
                </div>
    ...
    <!--chose us area start-->
    <div class="choseus_area" data-bgimg="{{ cdn('frontend') }}/img/about/about-us-policy-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="{{ cdn('frontend') }}/img/about/About_icon1.png" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="{{ cdn('frontend') }}/img/about/About_icon2.png" alt="">
                        </div>
                        <div class="chose_content">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="{{ cdn('frontend') }}/img/about/About_icon3.png" alt="">
                        </div>
                        <div class="chose_content">
                ...
                <div class="row">
                        ...
                        <article class="single_gallery_section">
                            <figure>
                                <div class="gallery_thumb">
                                    <img src="{{ cdn('frontend') }}/img/about/about2.jpg" alt="">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <article class="single_gallery_section">
                            <figure>
                                <div class="gallery_thumb">
                                    <img src="{{ cdn('frontend') }}/img/about/about3.jpg" alt="">
                                </div>
                                <figcaption class="about_gallery_content">
                                   <h3>Our Mission</h3>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto</p>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <article class="single_gallery_section">
                            <figure>
                                <div class="gallery_thumb">
                                    <img src="{{ cdn('frontend') }}/img/about/about4.jpg" alt="">
                                </div>
                                <figcaption class="about_gallery_content">
                                   <h3>History Of Us</h3>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto</p>
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <div class="testimonial_area  testimonial_about">
                        ...
                        <div class="testimonial_container">
                            <div class="testimonial_carousel testimonial_about_two owl-carousel">
                                <div class="single_testimonial">
                                    <div class="testimonial_thumb">
                                        <a href="#"><img src="{{ cdn('frontend') }}/img/about/testimonial1.png" alt=""></a>
                                    </div>
                                    <div class="testimonial_content">
                                        <div class="testimonial_icon_img">
                                            <img src="{{ cdn('frontend') }}/img/about/testimonials-icon.png" alt="">
                                        </div>
                                ...
                                <div class="single_testimonial">
                                    <div class="testimonial_thumb">
                                        <a href="#"><img src="{{ cdn('frontend') }}/img/about/testimonial2.png" alt=""></a>
                                    </div>
                                    <div class="testimonial_content">
                                        <div class="testimonial_icon_img">
                                            <img src="{{ cdn('frontend') }}/img/about/testimonials-icon.png" alt="">
                                ...
                                <div class="single_testimonial">
                                    <div class="testimonial_thumb">
                                        <a href="#"><img src="{{ cdn('frontend') }}/img/about/testimonial3.png" alt=""></a>
                                    </div>
                                    <div class="testimonial_content">
                                        <div class="testimonial_icon_img">
                                            <img src="{{ cdn('frontend') }}/img/about/testimonials-icon.png" alt="">
